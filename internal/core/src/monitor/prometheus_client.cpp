...
std::map<std::string, std::string> postfilterLatencyLabels{
    {"type", "postfilter_latency"}};
...
DEFINE_PROMETHEUS_HISTOGRAM(internal_core_search_latency_postfilter,
                            internal_core_search_latency,
                            postfilterLatencyLabels)
