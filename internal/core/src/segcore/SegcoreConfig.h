...
class SegcoreConfig {
 ...
 private:
    ...
    inline static bool global_refine_enable_ = false;
    inline static float search_topk_ratio_ = 1.0f;
    inline static float refine_topk_ratio_ = 1.0f;

 public:
    void
    set_global_refine_enable(bool enable) {
        global_refine_enable_ = enable;
    }

    bool
    get_global_refine_enable() const {
        return global_refine_enable_;
    }
